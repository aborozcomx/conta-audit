    ...
    public function onRow(Row $row)
    {
        ...
        if($row['uuid']) {
            $employee = Employee::firstOrCreate(
                ...
                [
                    'name' => $row['nombrereceptor'] ?? 'N/A',
                    'clave' => $row['numempleado'] ?? 'N/A',
                    'puesto' => $row['pueston'] ?? 'N/A',
                    'depto' => $row['departamento'] ?? 'N/A',
                    'curp' => '' ?? 'N/A',
                    'rfc' => '--',
                    'age' => '',
                    'start_date' => $row['fechainiciorellaboral'] ?? 'N/A',
                    'number' => $row['numempleado'] ?? 'N/A',
                    'social_number' => $row['numseguridadsocial'] ?? 'N/A',
                    'base_salary' => $row['salariobasecotapor'] ?? 'N/A',
                    'daily_salary' => $row['salariobasecotapor'] ?? 'N/A',
